...
public class VCCW01 extends JFrame{
	...
	class Renderer implements GLEventListener, KeyListener{
		...
		//definition scale, thought scale, change size 
		private float scale = 1;
		//definition translation move along x
		private float translatex=0;
		//definition translation move along y
		private float translatey=0;
		//definition rotation along x
		private float rotatex=0;
		//definition rotation along y
		...
		public void display(GLAutoDrawable drawable) {
			...
			//the rotation of x-axis, anti-clockwise
			T.rotateX(rotatex);
			//the rotation of y-axis, anti-clockwise
			T.rotateY(rotatey);
			//move the items, change x or y
...
//		    gl.glDepthFunc(GL_LESS);
		...
		public void keyPressed(KeyEvent ke) {
			...
			case KeyEvent.VK_N:
				scale /=1.1;
				break;
			//LEFT move item to left along x
			case KeyEvent.VK_LEFT:
				translatex -=0.1;
				break;
			//RIGHT move item to right along y
			case KeyEvent.VK_RIGHT:
				translatex +=0.1;
				break;
			//X  rotation anti-clockwise along x
			case KeyEvent.VK_X:
				rotatex +=1.1;
				break;
			//Y  rotation anti-clockwise along y
			case KeyEvent.VK_Y:
				rotatey +=1.1;
				break;
			//DOWN move item to down along y
			case KeyEvent.VK_DOWN:
				translatey -=0.1;
				break;
			//UP move item up along y
			case KeyEvent.VK_UP:
				translatey +=0.1;
				break;
