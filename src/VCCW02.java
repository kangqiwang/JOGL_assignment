...
//			T.LookAt(0, 0, 0, 0, 0, -100, 0, 1, 0);  	//Default					
		...
		public void init(GLAutoDrawable drawable) {
		   ...
		   SObject cylinder = new SCylinder(1,2);
		  ...
		  idElement=1;
		   ...
		   Vec4 materialAmbient2 = new Vec4(0.1f, 0.9f, 0.0f, 0.0f);
		    Vec4 materialDiffuse2 = new Vec4(0.6f, 0.6f, 0.7f, 1.0f);
		    Vec4 materialSpecular2 = new Vec4(0.3f, 0.3f, 0.30f, 1.0f);
		    materialShininess2 = 10.0f;
